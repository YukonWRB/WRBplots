...
# file.copy(from = paste0(dirname(getwd()), "/doc/WRBplots_guide.html"), to = "//env-fs/env-data/corp/water/Common_GW_SW/R-packages/WRBplots/WRBplots user guide.html", overwrite = TRUE)
```
